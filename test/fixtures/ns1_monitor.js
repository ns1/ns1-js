...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, {"notify_list":[{"type":"email","config":{"email":"email+notify@gmail.com"}}],"name":"My Notification List","id":"568afc20830f780493f5f031"}, { date: 'Mon, 04 Jan 2016 23:11:28 GMT',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .put('/v1/monitoring/jobs', {"notify_regional":false,"notify_failback":true,"notify_repeat":0,"notify_delay":1000000,"rules":[{"value":"200 OK","comparison":"contains","key":"output"},{"value":200,"comparison":"<=","key":"connect"}],"config":{"ssl":"1","send":"HEAD / HTTP/1.0\r\n\r\n","port":443,"host":"1.2.3.4"},"job_type":"tcp","name":"myotherhost.com:443 monitor","active":true,"rapid_recheck":true,"region_scope":"fixed","regions":["master"],"frequency":30000000,"policy":"quorum","notes":"If this monitor is down then the webserver on myhost.com:443 is down or too slow!","notify_list":"568afc20830f780493f5f031"})
  .reply(200, {"notify_list":"568afc20830f780493f5f031","notify_delay":1000000,"job_type":"tcp","frequency":30000000,"rapid_recheck":true,"region_scope":"fixed","id":"568afc20830f78042301711b","notify_repeat":0,"notify_regional":false,"regions":["master"],"policy":"quorum","config":{"ssl":"1","host":"1.2.3.4","port":443,"send":"HEAD / HTTP/1.0\r\n\r\n"},"status":{"global":{"status":"pending","since":1451949088}},"notify_failback":true,"rules":[{"comparison":"contains","key":"output","value":"200 OK"},{"comparison":"<=","key":"connect","value":200}],"active":true,"name":"myotherhost.com:443 monitor","notes":"If this monitor is down then the webserver on myhost.com:443 is down or too slow!"}, { date: 'Mon, 04 Jan 2016 23:11:28 GMT',
  'content-type': 'application/json',
  'content-length': '685',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/monitoring/jobs/568afc20830f78042301711b')
  .reply(200, {"notify_list":"568afc20830f780493f5f031","notify_delay":1000000,"job_type":"tcp","frequency":30000000,"rapid_recheck":true,"region_scope":"fixed","id":"568afc20830f78042301711b","notify_repeat":0,"notify_regional":false,"regions":["master"],"policy":"quorum","config":{"ssl":"1","host":"1.2.3.4","port":443,"send":"HEAD / HTTP/1.0\r\n\r\n"},"status":{"global":{"status":"pending","since":1451949088}},"notify_failback":true,"rules":[{"comparison":"contains","value":"200 OK","key":"output"},{"comparison":"<=","value":200,"key":"connect"}],"active":true,"name":"myotherhost.com:443 monitor","notes":"If this monitor is down then the webserver on myhost.com:443 is down or too slow!"}, { date: 'Mon, 04 Jan 2016 23:11:28 GMT',
  'content-type': 'application/json',
  'content-length': '685',
  connection: 'close',
  'x-ratelimit-remaining': '999',
  etag: '"568c0a573f060989b4aa82307c1cde4bda5316b4"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '1000',
  'x-ratelimit-period': '1',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .post('/v1/monitoring/jobs/568afc20830f78042301711b', {"notify_list":"568afc20830f780493f5f031","notify_delay":1000000,"job_type":"tcp","frequency":30000000,"rapid_recheck":true,"region_scope":"fixed","id":"568afc20830f78042301711b","notify_repeat":0,"notify_regional":false,"regions":["master"],"policy":"quorum","config":{"ssl":"1","host":"1.2.3.4","port":443,"send":"HEAD / HTTP/1.0\r\n\r\n"},"status":{"global":{"status":"pending","since":1451949088}},"notify_failback":true,"rules":[{"comparison":"contains","value":"200 OK","key":"output"},{"comparison":"<=","value":200,"key":"connect"}],"active":true,"name":"test update","notes":"If this monitor is down then the webserver on myhost.com:443 is down or too slow!"})
  .reply(200, {"notify_list":"568afc20830f780493f5f031","notify_delay":1000000,"job_type":"tcp","frequency":30000000,"rapid_recheck":true,"region_scope":"fixed","id":"568afc20830f78042301711b","notify_repeat":0,"notify_regional":false,"regions":["master"],"policy":"quorum","config":{"ssl":"1","host":"1.2.3.4","port":443,"send":"HEAD / HTTP/1.0\r\n\r\n"},"status":{"global":{"status":"pending","since":1451949088}},"notify_failback":true,"rules":[{"comparison":"contains","key":"output","value":"200 OK"},{"comparison":"<=","key":"connect","value":200}],"active":true,"name":"test update","notes":"If this monitor is down then the webserver on myhost.com:443 is down or too slow!"}, { date: 'Mon, 04 Jan 2016 23:11:28 GMT',
  'content-type': 'application/json',
  'content-length': '669',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/monitoring/jobs/568afc20830f78042301711b')
  .reply(200, {"notify_list":"568afc20830f780493f5f031","notify_delay":1000000,"job_type":"tcp","frequency":30000000,"rapid_recheck":true,"region_scope":"fixed","id":"568afc20830f78042301711b","notify_repeat":0,"notify_regional":false,"regions":["master"],"policy":"quorum","config":{"ssl":"1","host":"1.2.3.4","port":443,"send":"HEAD / HTTP/1.0\r\n\r\n"},"status":{"global":{"status":"pending","since":1451949088}},"notify_failback":true,"rules":[{"comparison":"contains","value":"200 OK","key":"output"},{"comparison":"<=","value":200,"key":"connect"}],"active":true,"name":"test update","notes":"If this monitor is down then the webserver on myhost.com:443 is down or too slow!"}, { date: 'Mon, 04 Jan 2016 23:11:28 GMT',
  'content-type': 'application/json',
  'content-length': '669',
  connection: 'close',
  'x-ratelimit-remaining': '999',
  etag: '"73bf10e2f7bf72e007fedfd371d0be0b889f35e2"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '1000',
  'x-ratelimit-period': '1',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .post('/v1/monitoring/jobs/568afc20830f78042301711b', {"notify_list":"568afc20830f780493f5f031","notify_delay":1000000,"job_type":"tcp","frequency":30000000,"rapid_recheck":true,"region_scope":"fixed","id":"568afc20830f78042301711b","notify_repeat":0,"notify_regional":false,"regions":["master"],"policy":"quorum","config":{"ssl":"1","host":"1.2.3.4","port":443,"send":"HEAD / HTTP/1.0\r\n\r\n"},"status":{"global":{"status":"pending","since":1451949088}},"notify_failback":true,"rules":[{"comparison":"contains","value":"200 OK","key":"output"},{"comparison":"<=","value":200,"key":"connect"}],"active":true,"name":"myotherhost.com:443 monitor","notes":"If this monitor is down then the webserver on myhost.com:443 is down or too slow!"})
  .reply(200, {"notify_list":"568afc20830f780493f5f031","notify_delay":1000000,"job_type":"tcp","frequency":30000000,"rapid_recheck":true,"region_scope":"fixed","id":"568afc20830f78042301711b","notify_repeat":0,"notify_regional":false,"regions":["master"],"policy":"quorum","config":{"ssl":"1","host":"1.2.3.4","port":443,"send":"HEAD / HTTP/1.0\r\n\r\n"},"status":{"global":{"status":"pending","since":1451949088}},"notify_failback":true,"rules":[{"comparison":"contains","key":"output","value":"200 OK"},{"comparison":"<=","key":"connect","value":200}],"active":true,"name":"myotherhost.com:443 monitor","notes":"If this monitor is down then the webserver on myhost.com:443 is down or too slow!"}, { date: 'Mon, 04 Jan 2016 23:11:29 GMT',
  'content-type': 'application/json',
  'content-length': '685',
  connection: 'close',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .put('/v1/monitoring/jobs', {"notify_regional":false,"notify_failback":true,"notify_repeat":0,"notify_delay":1000000,"rules":[{"value":"200 OK","comparison":"contains","key":"output"},{"value":200,"comparison":"<=","key":"connect"}],"config":{"ssl":"1","send":"HEAD / HTTP/1.0\r\n\r\n","port":443,"host":"1.2.3.4"},"job_type":"tcp","name":"myotherhost.com:443 monitor","active":true,"rapid_recheck":true,"region_scope":"fixed","regions":["master"],"frequency":30000000,"policy":"quorum","notes":"If this monitor is down then the webserver on myhost.com:443 is down or too slow!","notify_list":"568afc20830f780493f5f031"})
  .reply(200, {"notify_list":"568afc20830f780493f5f031","notify_delay":1000000,"job_type":"tcp","frequency":30000000,"rapid_recheck":true,"region_scope":"fixed","id":"568afc21830f780493f5f034","notify_repeat":0,"notify_regional":false,"regions":["master"],"policy":"quorum","config":{"ssl":"1","host":"1.2.3.4","port":443,"send":"HEAD / HTTP/1.0\r\n\r\n"},"status":{"global":{"status":"pending","since":1451949089}},"notify_failback":true,"rules":[{"comparison":"contains","key":"output","value":"200 OK"},{"comparison":"<=","key":"connect","value":200}],"active":true,"name":"myotherhost.com:443 monitor","notes":"If this monitor is down then the webserver on myhost.com:443 is down or too slow!"}, { date: 'Mon, 04 Jan 2016 23:11:29 GMT',
  'content-type': 'application/json',
  'content-length': '685',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .delete('/v1/monitoring/jobs/568afc21830f780493f5f034')
  .reply(200, {}, { date: 'Mon, 04 Jan 2016 23:11:29 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/monitoring/history/568afc20830f78042301711b')
  .query({"period":"30d"})
  .reply(200, [{"status":"pending","region":"global","since":1451949088,"job":"568afc20830f78042301711b","until":null}], { date: 'Mon, 04 Jan 2016 23:11:29 GMT',
  'content-type': 'application/json',
  'content-length': '106',
  connection: 'close',
  'x-ratelimit-remaining': '999',
  etag: '"e5847bfd4800170314913f0c885680db84fa84ea"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '1000',
  'x-ratelimit-period': '1',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/monitoring/metrics/568afc20830f78042301711b')
  .reply(200, [], { date: 'Mon, 04 Jan 2016 23:11:29 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, [{"subnets":["192.168.50.200/32"],"code":"master","name":"Master"},{"subnets":["192.168.50.201/32"],"code":"satellite","name":"Satellite"}], { date: 'Mon, 04 Jan 2016 23:11:29 GMT',
  'content-type': 'application/json',
  'content-length': '140',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .delete('/v1/monitoring/jobs/568afc20830f78042301711b')
  .reply(200, {}, { date: 'Mon, 04 Jan 2016 23:11:29 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .delete('/v1/lists/568afc20830f780493f5f031')
  .reply(200, {}, { date: 'Mon, 04 Jan 2016 23:11:29 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
