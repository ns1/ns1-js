...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"603e393c8beb5e6e8a45bca311942db7","sourcetype":"monitor_us"}, { date: 'Thu, 24 Dec 2015 04:26:35 GMT',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  ...
  etag: '"15a13bd8758842b23c4623ba25f47fd4c2111c60"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/data/sources/603e393c8beb5e6e8a45bca311942db7')
  .reply(200, {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"603e393c8beb5e6e8a45bca311942db7","sourcetype":"monitor_us"}, { date: 'Thu, 24 Dec 2015 04:26:35 GMT',
  'content-type': 'application/json',
  'content-length': '218',
  connection: 'close',
  'x-ratelimit-remaining': '898',
  etag: '"4d4c59d98ef8628cc89876e4578530b911f83128"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '900',
  'x-ratelimit-period': '300',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  .post('/v1/data/sources/603e393c8beb5e6e8a45bca311942db7', {"status":"pending","name":"test update","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"603e393c8beb5e6e8a45bca311942db7","sourcetype":"monitor_us"})
  .reply(200, {"status":"pending","name":"test update","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"603e393c8beb5e6e8a45bca311942db7","sourcetype":"monitor_us"}, { date: 'Thu, 24 Dec 2015 04:26:35 GMT',
  'content-type': 'application/json',
  'content-length': '211',
  connection: 'close',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  ...
  connection: 'close',
  'x-ratelimit-remaining': '897',
  etag: '"1f79f55e05def13bed7ac8d94bea203e2678f560"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '900',
  'x-ratelimit-period': '300',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  .post('/v1/data/sources/603e393c8beb5e6e8a45bca311942db7', {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"603e393c8beb5e6e8a45bca311942db7","sourcetype":"monitor_us"})
  .reply(200, {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"603e393c8beb5e6e8a45bca311942db7","sourcetype":"monitor_us"}, { date: 'Thu, 24 Dec 2015 04:26:35 GMT',
  'content-type': 'application/json',
  'content-length': '218',
  connection: 'close',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, {"status":"pending","name":"Monitor.us Example 2","feeds":[],"config":{"secret_key":"47CAGRFTA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXR377TXAY0FJA7T9VZY"},"id":"f139b11d1779be7bcb5de3143650e5d9","sourcetype":"monitor_us"}, { date: 'Thu, 24 Dec 2015 04:26:36 GMT',
  'content-type': 'application/json',
  'content-length': '220',
  connection: 'close',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/data/sources')
  .reply(200, [{"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"603e393c8beb5e6e8a45bca311942db7","sourcetype":"monitor_us"},{"status":"pending","name":"Monitor.us Example 2","feeds":[],"config":{"secret_key":"47CAGRFTA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXR377TXAY0FJA7T9VZY"},"id":"f139b11d1779be7bcb5de3143650e5d9","sourcetype":"monitor_us"}], { date: 'Thu, 24 Dec 2015 04:26:36 GMT',
  'content-type': 'application/json',
  'content-length': '440',
  connection: 'close',
  'x-ratelimit-remaining': '895',
  etag: '"89f9627088e532a33a9feb45a5ba16495216c83b"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '900',
  'x-ratelimit-period': '300',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  .delete('/v1/data/sources/f139b11d1779be7bcb5de3143650e5d9')
  .reply(200, {}, { date: 'Thu, 24 Dec 2015 04:26:36 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
  'x-ratelimit-remaining': '99',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/data/sources')
  .reply(200, [{"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"603e393c8beb5e6e8a45bca311942db7","sourcetype":"monitor_us"}], { date: 'Thu, 24 Dec 2015 04:26:36 GMT',
  'content-type': 'application/json',
  'content-length': '220',
  connection: 'close',
  'x-ratelimit-remaining': '895',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  .delete('/v1/data/sources/603e393c8beb5e6e8a45bca311942db7')
  .reply(200, {}, { date: 'Thu, 24 Dec 2015 04:26:36 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
