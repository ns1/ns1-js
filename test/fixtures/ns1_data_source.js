...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"abd13d7a6e55d0b04be0bc16e1046e44","sourcetype":"monitor_us"}, { date: 'Mon, 28 Dec 2015 21:50:30 GMT',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  ...
  connection: 'close',
  'x-ratelimit-remaining': '999',
  etag: '"fca5c2d32dbafa6fd00cc1db8a2da0223ea1266d"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '1000',
  'x-ratelimit-period': '1',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/data/sources/abd13d7a6e55d0b04be0bc16e1046e44')
  .reply(200, {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"abd13d7a6e55d0b04be0bc16e1046e44","sourcetype":"monitor_us"}, { date: 'Mon, 28 Dec 2015 21:50:30 GMT',
  'content-type': 'application/json',
  'content-length': '218',
  connection: 'close',
  'x-ratelimit-remaining': '999',
  etag: '"9c72b504f45a1a04c0ba4272eece4f50c6d962b3"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '1000',
  'x-ratelimit-period': '1',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .post('/v1/data/sources/abd13d7a6e55d0b04be0bc16e1046e44', {"status":"pending","name":"test update","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"abd13d7a6e55d0b04be0bc16e1046e44","sourcetype":"monitor_us"})
  .reply(200, {"status":"pending","name":"test update","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"abd13d7a6e55d0b04be0bc16e1046e44","sourcetype":"monitor_us"}, { date: 'Mon, 28 Dec 2015 21:50:30 GMT',
  'content-type': 'application/json',
  'content-length': '211',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  ...
  connection: 'close',
  'x-ratelimit-remaining': '999',
  etag: '"c700ee43bbb80369072ff18671701ef720b04dda"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '1000',
  'x-ratelimit-period': '1',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .post('/v1/data/sources/abd13d7a6e55d0b04be0bc16e1046e44', {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"abd13d7a6e55d0b04be0bc16e1046e44","sourcetype":"monitor_us"})
  .reply(200, {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"abd13d7a6e55d0b04be0bc16e1046e44","sourcetype":"monitor_us"}, { date: 'Mon, 28 Dec 2015 21:50:30 GMT',
  'content-type': 'application/json',
  'content-length': '218',
  connection: 'close',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, {"status":"pending","name":"Monitor.us Example 2","feeds":[],"config":{"secret_key":"47CAGRFTA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXR377TXAY0FJA7T9VZY"},"id":"074f22fc4d795aceb90b622e1943543f","sourcetype":"monitor_us"}, { date: 'Mon, 28 Dec 2015 21:50:30 GMT',
  'content-type': 'application/json',
  'content-length': '220',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/data/sources')
  .reply(200, [{"status":"pending","name":"Monitor.us Example 2","feeds":[],"config":{"secret_key":"47CAGRFTA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXR377TXAY0FJA7T9VZY"},"id":"074f22fc4d795aceb90b622e1943543f","sourcetype":"monitor_us"},{"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"abd13d7a6e55d0b04be0bc16e1046e44","sourcetype":"monitor_us"}], { date: 'Mon, 28 Dec 2015 21:50:31 GMT',
  'content-type': 'application/json',
  'content-length': '440',
  connection: 'close',
  'x-ratelimit-remaining': '999',
  etag: '"0b6cd200298ec17a731df3cc29da07fd3e35a45b"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '1000',
  'x-ratelimit-period': '1',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .delete('/v1/data/sources/074f22fc4d795aceb90b622e1943543f')
  .reply(200, {}, { date: 'Mon, 28 Dec 2015 21:50:31 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/data/sources')
  .reply(200, [{"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"abd13d7a6e55d0b04be0bc16e1046e44","sourcetype":"monitor_us"}], { date: 'Mon, 28 Dec 2015 21:50:31 GMT',
  'content-type': 'application/json',
  'content-length': '220',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .delete('/v1/data/sources/abd13d7a6e55d0b04be0bc16e1046e44')
  .reply(200, {}, { date: 'Mon, 28 Dec 2015 21:50:31 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
