...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"8e8c8fd7fc72e3446e5ed8fe5097e448","sourcetype":"monitor_us"}, { date: 'Mon, 04 Jan 2016 23:11:27 GMT',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  ...
  connection: 'close',
  'x-ratelimit-remaining': '999',
  etag: '"4788626862e466b5e50bd543e115aa2869c9e32f"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '1000',
  'x-ratelimit-period': '1',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/data/sources/8e8c8fd7fc72e3446e5ed8fe5097e448')
  .reply(200, {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"8e8c8fd7fc72e3446e5ed8fe5097e448","sourcetype":"monitor_us"}, { date: 'Mon, 04 Jan 2016 23:11:27 GMT',
  'content-type': 'application/json',
  'content-length': '218',
  connection: 'close',
  'x-ratelimit-remaining': '999',
  etag: '"65a412523dd16941cc78f5c6622de734af96d0cc"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '1000',
  'x-ratelimit-period': '1',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .post('/v1/data/sources/8e8c8fd7fc72e3446e5ed8fe5097e448', {"status":"pending","name":"test update","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"8e8c8fd7fc72e3446e5ed8fe5097e448","sourcetype":"monitor_us"})
  .reply(200, {"status":"pending","name":"test update","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"8e8c8fd7fc72e3446e5ed8fe5097e448","sourcetype":"monitor_us"}, { date: 'Mon, 04 Jan 2016 23:11:27 GMT',
  'content-type': 'application/json',
  'content-length': '211',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  ...
  connection: 'close',
  'x-ratelimit-remaining': '999',
  etag: '"fb13da243f8cb892bf739d9dd34f715ec94018d4"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '1000',
  'x-ratelimit-period': '1',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .post('/v1/data/sources/8e8c8fd7fc72e3446e5ed8fe5097e448', {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"8e8c8fd7fc72e3446e5ed8fe5097e448","sourcetype":"monitor_us"})
  .reply(200, {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"8e8c8fd7fc72e3446e5ed8fe5097e448","sourcetype":"monitor_us"}, { date: 'Mon, 04 Jan 2016 23:11:27 GMT',
  'content-type': 'application/json',
  'content-length': '218',
  connection: 'close',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, {"status":"pending","name":"Monitor.us Example 2","feeds":[],"config":{"secret_key":"47CAGRFTA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXR377TXAY0FJA7T9VZY"},"id":"34f0690f732c896fefdef5c10356b8ef","sourcetype":"monitor_us"}, { date: 'Mon, 04 Jan 2016 23:11:28 GMT',
  'content-type': 'application/json',
  'content-length': '220',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/data/sources')
  .reply(200, [{"status":"pending","name":"Monitor.us Example 2","feeds":[],"config":{"secret_key":"47CAGRFTA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXR377TXAY0FJA7T9VZY"},"id":"34f0690f732c896fefdef5c10356b8ef","sourcetype":"monitor_us"},{"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"8e8c8fd7fc72e3446e5ed8fe5097e448","sourcetype":"monitor_us"}], { date: 'Mon, 04 Jan 2016 23:11:28 GMT',
  'content-type': 'application/json',
  'content-length': '440',
  connection: 'close',
  'x-ratelimit-remaining': '999',
  etag: '"52e450a4976b6dea2d230ca4c29f2a6ff8954dca"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '1000',
  'x-ratelimit-period': '1',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .delete('/v1/data/sources/34f0690f732c896fefdef5c10356b8ef')
  .reply(200, {}, { date: 'Mon, 04 Jan 2016 23:11:28 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/data/sources')
  .reply(200, [{"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"8e8c8fd7fc72e3446e5ed8fe5097e448","sourcetype":"monitor_us"}], { date: 'Mon, 04 Jan 2016 23:11:28 GMT',
  'content-type': 'application/json',
  'content-length': '220',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .delete('/v1/data/sources/8e8c8fd7fc72e3446e5ed8fe5097e448')
  .reply(200, {}, { date: 'Mon, 04 Jan 2016 23:11:28 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
