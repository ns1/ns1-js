...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"6f97fe64a2291e35730bdbff73eed42b","sourcetype":"monitor_us"}, { date: 'Thu, 24 Dec 2015 06:00:17 GMT',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  ...
  etag: '"dc45456f83dbeaf8d44b240c86c68454a9862ec7"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/data/sources/6f97fe64a2291e35730bdbff73eed42b')
  .reply(200, {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"6f97fe64a2291e35730bdbff73eed42b","sourcetype":"monitor_us"}, { date: 'Thu, 24 Dec 2015 06:00:17 GMT',
  'content-type': 'application/json',
  'content-length': '218',
  connection: 'close',
  'x-ratelimit-remaining': '898',
  etag: '"2224599937e6c8c88a84c08e712170bea15d3e23"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '900',
  'x-ratelimit-period': '300',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  .post('/v1/data/sources/6f97fe64a2291e35730bdbff73eed42b', {"status":"pending","name":"test update","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"6f97fe64a2291e35730bdbff73eed42b","sourcetype":"monitor_us"})
  .reply(200, {"status":"pending","name":"test update","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"6f97fe64a2291e35730bdbff73eed42b","sourcetype":"monitor_us"}, { date: 'Thu, 24 Dec 2015 06:00:18 GMT',
  'content-type': 'application/json',
  'content-length': '211',
  connection: 'close',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  ...
  connection: 'close',
  'x-ratelimit-remaining': '897',
  etag: '"e2b8552b11dd2ba80e895a31c0d31dadca2d13d9"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '900',
  'x-ratelimit-period': '300',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  .post('/v1/data/sources/6f97fe64a2291e35730bdbff73eed42b', {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"6f97fe64a2291e35730bdbff73eed42b","sourcetype":"monitor_us"})
  .reply(200, {"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"6f97fe64a2291e35730bdbff73eed42b","sourcetype":"monitor_us"}, { date: 'Thu, 24 Dec 2015 06:00:18 GMT',
  'content-type': 'application/json',
  'content-length': '218',
  connection: 'close',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, {"status":"pending","name":"Monitor.us Example 2","feeds":[],"config":{"secret_key":"47CAGRFTA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXR377TXAY0FJA7T9VZY"},"id":"1bc955bf217659af525b2338c3abeedf","sourcetype":"monitor_us"}, { date: 'Thu, 24 Dec 2015 06:00:18 GMT',
  'content-type': 'application/json',
  'content-length': '220',
  connection: 'close',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/data/sources')
  .reply(200, [{"status":"pending","name":"Monitor.us Example 2","feeds":[],"config":{"secret_key":"47CAGRFTA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXR377TXAY0FJA7T9VZY"},"id":"1bc955bf217659af525b2338c3abeedf","sourcetype":"monitor_us"},{"status":"pending","name":"Monitor.us Example","feeds":[],"config":{"secret_key":"47AOG8ATA1QNUC3H3UH2DRBXYZ","api_key":"15PSVFCXA377TGUY0FJA7T9VZY"},"id":"6f97fe64a2291e35730bdbff73eed42b","sourcetype":"monitor_us"}], { date: 'Thu, 24 Dec 2015 06:00:18 GMT',
  'content-type': 'application/json',
  'content-length': '440',
  connection: 'close',
  'x-ratelimit-remaining': '895',
  etag: '"b3b26aea3c9a30e917e32c7724b457bae1dcfe3e"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '900',
  'x-ratelimit-period': '300',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  .delete('/v1/data/sources/1bc955bf217659af525b2338c3abeedf')
  .reply(200, {}, { date: 'Thu, 24 Dec 2015 06:00:18 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
  'x-ratelimit-remaining': '99',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  .delete('/v1/data/sources/6f97fe64a2291e35730bdbff73eed42b')
  .reply(200, {}, { date: 'Thu, 24 Dec 2015 06:00:18 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
