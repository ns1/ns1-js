...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/stats/qps/')
  .reply(200, {"qps":0}, { date: 'Mon, 04 Jan 2016 22:35:11 GMT',
  'content-type': 'application/json',
  'content-length': '12',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  .get('/v1/stats/usage/')
  .reply(200, [{"jobs":0,"graph":[],"period":"24h","zones":2,"records":3,"queries":0,"feeds":0}], { date: 'Mon, 04 Jan 2016 22:35:11 GMT',
  'content-type': 'application/json',
  'content-length': '91',
  connection: 'close',
  'x-ratelimit-remaining': '999',
  etag: '"0d40674732b3d3173bd8f680aac7944dc2f33d2f"',
  'x-ratelimit-by': 'customer',
  server: 'NSONE API v1',
  'x-ratelimit-limit': '1000',
  'x-ratelimit-period': '1',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, [{"records":1,"graph":[],"period":"24h","zone":"testdomain.test","queries":0}], { date: 'Mon, 04 Jan 2016 22:35:11 GMT',
  'content-type': 'application/json',
  'content-length': '81',
  connection: 'close',
  'x-ratelimit-remaining': '999',
...
nock('https://portal.vagrant.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, {}, { date: 'Mon, 04 Jan 2016 22:35:11 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
  'x-ratelimit-remaining': '999',
