...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, {"domain":"www.testdomain.test","zone":"testdomain.test","use_client_subnet":true,"answers":[{"answer":["1.1.1.1"],"id":"56733cd82db15617c11301bd"}],"id":"56733cd82db15617c11301be","regions":{},"meta":{},"link":null,"filters":[],"ttl":3600,"tier":1,"type":"A","networks":[0]}, { date: 'Thu, 17 Dec 2015 22:53:12 GMT',
  'content-type': 'application/json',
  'content-length': '276',
  connection: 'close',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, {}, { date: 'Thu, 17 Dec 2015 22:53:13 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
  'x-ratelimit-remaining': '99',
