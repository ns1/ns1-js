...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, {"domain":"www.testdomain.test","zone":"testdomain.test","use_client_subnet":true,"answers":[{"answer":["1.1.1.1"],"id":"567313772db15617c112f659"}],"id":"567313772db15617c112f65a","regions":{},"meta":{},"link":null,"filters":[],"ttl":3600,"tier":1,"type":"A","networks":[0]}, { date: 'Thu, 17 Dec 2015 19:56:39 GMT',
  'content-type': 'application/json',
  'content-length': '276',
  connection: 'close',
...
nock('https://api.nsone.net:443', {"encodedQueryParams":true})
  ...
  .reply(200, {}, { date: 'Thu, 17 Dec 2015 19:56:40 GMT',
  'content-type': 'application/json',
  'content-length': '3',
  connection: 'close',
  'x-ratelimit-remaining': '99',
